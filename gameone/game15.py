...
def normalise_input(user_input):
    ...
    'help'
    """
    # 1. Coverting the letters to lower case
    lower = user_input.lower()

    # 2. Removing the punctation
    removedPunct = remove_punct(lower)

    # 3. Remove space
    removedSpace = remove_spaces(removedPunct)
